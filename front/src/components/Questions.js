const questions = [
  ...
  {
    question:
      "Décrivez une situation où vous avez dû faire face à un conflit au travail et comment vous l'avez résolu.",
    status: 'Inclusive et respecte la législation',
  },
  {
    question:
  ...
  {
    question:
      'Quelle est votre religion? Cela pourrait-il affecter votre capacité à travailler les jours fériés?',
    status: 'Non inclusive et ne respecte pas la législation (discriminatoire)',
  },
];
